...
### PHP 8.6.0-dev/master
[https://github.com/shivammathur/php-builder-windows/releases/tag/php8.6](https://github.com/shivammathur/php-builder-windows/releases/tag/php8.6)
